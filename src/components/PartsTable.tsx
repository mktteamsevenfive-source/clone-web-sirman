...
import { Search, ShoppingCart, CheckCircle2, Loader2, Star, Target } from 'lucide-react';
            ...
            <div className="p-4 bg-slate-50 border-b border-slate-200">
                <div className="flex items-center justify-between mb-3">
                    <h3 className="font-bold text-slate-900 text-sm flex items-center gap-2">
                        ...
                        {selectedRef && (
                            <span className="inline-flex items-center gap-1 bg-red-100 text-[#C8102E] text-[11px] font-bold px-2 py-0.5 rounded-full border border-red-200 animate-pulse">
                    ...
                    <label className="flex items-center gap-1.5 text-xs font-semibold text-slate-700 cursor-pointer select-none bg-white border border-slate-200 px-2.5 py-1 rounded-lg hover:border-slate-300 transition-all">
                        <input
                            type="checkbox"
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white text-slate-900 text-xs rounded-xl pl-9 pr-3 py-2 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#C8102E]/20 focus:border-[#C8102E] transition-all"
                    />
                </div>
            </div>
                        ...
                        return (
                            <div
                                ...
                                className={`p-3.5 transition-all flex items-center justify-between gap-3 text-xs cursor-pointer border-l-4 ${
                                    isSelected
                                        ? 'bg-red-50/80 border-l-[#C8102E] ring-1 ring-red-200 shadow-sm'
                            ...
                            >
                                <div className="space-y-0.5 min-w-0 flex-1">
                                    ...
                                    <div className={`font-medium truncate ${isSelected ? 'text-[#C8102E] font-bold' : 'text-slate-600'}`}>
                                        {part.name}
                                    </div>
                                ...
                                <div className="text-right flex-shrink-0 space-y-1">
                                    ...
                                    <button className="inline-flex items-center gap-1 bg-[#C8102E] hover:bg-[#A00C24] text-white text-[10px] font-bold px-2.5 py-1 rounded-lg transition-all shadow-sm active:scale-95 cursor-pointer">
