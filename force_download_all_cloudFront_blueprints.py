"""
FORCE OVERWRITE ALL DIAGRAM IMAGES WITH AUTHENTIC CLOUDFRONT BLUEPRINTS
========================================================================
Overwrites every single file in diagram_images/ with Sirman's official
full-resolution CloudFront signed diagram images.
"""
...
async def main():
    print("=" * 65)
    print("  FORCE RE-DOWNLOADING ALL 150 AUTHENTIC BLUEPRINT DIAGRAMS")
    print("=" * 65)
    ...
    async with async_playwright() as p:
        ...
        print(f"\n[STEP 2] Fetching CloudFront signed diagram images...")
        print("=" * 65)
    ...
    print("\n" + "=" * 65)
    print(f"  FORCE RE-DOWNLOAD COMPLETED!")
    print(f"  Saved authentic blueprints: {success_count}/{len(pdf_items)}")
